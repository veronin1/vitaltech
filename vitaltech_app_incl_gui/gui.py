...
class GUI:
    ...
    def widgets(self):
        ...
        tk.Label(user_info_frame, text="Height:", bg="#f2f2f2").grid(row=row, column=0, sticky="e", padx=5, pady=5)
        self.height_entry = tk.Entry(user_info_frame, width=30)
        self.height_entry.grid(row=row, column=1, padx=5, pady=5)
        row += 1

        tk.Label(user_info_frame, text="Weight:", bg="#f2f2f2").grid(row=row, column=0, sticky="e", padx=5, pady=5)
